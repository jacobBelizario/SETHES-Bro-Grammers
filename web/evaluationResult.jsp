...
<form action="generategraph.action" method="post">
      <tr>
      	
          <td><%=records.getString("profID") %></td>
          <td><%=records.getString("profName") %></td>
          
          
     		<input type="hidden" name="profID" value="<%=records.getString("profID")%>"/>
     		
     		<input type="hidden" name="profName" value="<%=records.getString("profName")%>"/>
     		
    		<td><input type="submit" class="submit" value="Generate Graph"></a></td>
